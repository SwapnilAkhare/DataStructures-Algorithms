...
/*   NOW WE DONE SAME PROBLEM IN TIME COMPLEXITY IN O(N)
  FOR THAT WE CONCATE THE STRING WITH ITSELF S= S + S ..AND FIND A PALINDROMIC
   SUBSTRING OF LENGTH N IN MOSDIFIED STRING, IF SUBSTRING OF LENGTH  N PRESENT
    IN MODIFIED STRING THEN RETURN TRUE
 */
